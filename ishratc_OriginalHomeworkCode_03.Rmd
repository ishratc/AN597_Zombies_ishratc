...
head(d1)
par(mfrow =c(1,2))
h<-ggplot(data = d1, aes(x=(gender), y=(height)))
h<- p+geom_boxplot()
h
w<-ggplot(data = d1, aes(x=(gender), y=(weight)))
w<- p+geom_boxplot()
w
a<-ggplot(data = d1, aes(x=(gender), y=(age)))
a<- p+geom_boxplot()
a
z<-ggplot(data = d1, aes(x=(gender), y=(zombies_killed)))
z<- p+geom_boxplot()
z
y<-ggplot(data = d1, aes(x=(gender), y=(yrs_edu)))
y<- p+geom_boxplot()
y
