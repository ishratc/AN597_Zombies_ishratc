...
```{r}
qqnorm(d1,main="Normal QQ plot random normal variables")
qqline(v,col="gray")
```
...
foudn this package that gives a skewness coefficient haha kind of cool not sure if it means anthing though

```{r}
install.packages("e1071") #can't install this ?
library(e1071)
engine.displ<-skewness(yrs_edu)
engine.displ
